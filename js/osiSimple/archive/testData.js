const pdus=[
  {
    name:'Data',
    description:`Data is layer 7 to layer 5`
  },
  {
    name:'Segment',
    description:`segments are wrapped with sequence number in the case of tcp`
  },
  {
    name:'Packets',
    description:`is pdu of `
  },
  {
    name:'Frame',
    description:``
...
const OSILayers=[
  ...
  {
    name:"Presentation",
    description:"the presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into anotherthe presentation layer is responsible for translating data from binary into ASCII, encrypting data for security and converting data from one format into another",
    layerNum:6,
    pdu:'Data'
  },
  {
